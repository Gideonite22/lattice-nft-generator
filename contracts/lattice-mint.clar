;; Lattice NFT Generator - lattice-mint
;; A smart contract for creating, minting and trading unique lattice-based geometric art NFTs on the Stacks blockchain.
;; This contract handles the complete lifecycle of lattice NFTs, stores generation parameters on-chain,
